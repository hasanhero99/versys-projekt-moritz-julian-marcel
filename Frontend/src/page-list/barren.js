 ...
 */
export default class Barren extends Page {
    /**
     * Konstruktor.
     *
    ...
    async berechne(id) {
        ...
        competition.scoreHomeTeam.ParallelBars.Scores.Score1 = score[0][0];
        competition.scoreHomeTeam.ParallelBars.Scores.Score2 = score[0][1];
        competition.scoreHomeTeam.ParallelBars.Scores.Score3 = score[0][2];
        competition.scoreHomeTeam.ParallelBars.Scores.Score4 = score[0][3];

        competition.scoreAwayTeam.ParallelBars.Scores.Score1 = score[1][0];
        competition.scoreAwayTeam.ParallelBars.Scores.Score2 = score[1][1];
        competition.scoreAwayTeam.ParallelBars.Scores.Score3 = score[1][2];
        competition.scoreAwayTeam.ParallelBars.Scores.Score4 = score[1][3];
    ...
    async load(id, templateElement){
        ...
        let scoreDisciplineHome = competition.scoreHomeTeam.ParallelBars.Scores;
        let scoreDisciplineAway = competition.scoreAwayTeam.ParallelBars.Scores;
