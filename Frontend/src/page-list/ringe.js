 ...
 */
export default class Ringe extends Page {
    /**
     * Konstruktor.
     *
    ...
    async berechne(id) {
        ...
        competition.scoreHomeTeam.Rings.Scores.Score1 = score[0][0];
        competition.scoreHomeTeam.Rings.Scores.Score2 = score[0][1];
        competition.scoreHomeTeam.Rings.Scores.Score3 = score[0][2];
        competition.scoreHomeTeam.Rings.Scores.Score4 = score[0][3];

        competition.scoreAwayTeam.Rings.Scores.Score1 = score[1][0];
        competition.scoreAwayTeam.Rings.Scores.Score2 = score[1][1];
        competition.scoreAwayTeam.Rings.Scores.Score3 = score[1][2];
        competition.scoreAwayTeam.Rings.Scores.Score4 = score[1][3];
    ...
    async load(id, templateElement){
        ...
        let scoreDisciplineHome = competition.scoreHomeTeam.Rings.Scores;
        let scoreDisciplineAway = competition.scoreAwayTeam.Rings.Scores;
