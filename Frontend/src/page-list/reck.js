...
export default class Reck extends Page {
    ...
    async berechne(id) {
        ...
        competition.scoreHomeTeam.HorizontalBars.Scores.Score1 = score[0][0];
        competition.scoreHomeTeam.HorizontalBars.Scores.Score2 = score[0][1];
        competition.scoreHomeTeam.HorizontalBars.Scores.Score3 = score[0][2];
        competition.scoreHomeTeam.HorizontalBars.Scores.Score4 = score[0][3];

        competition.scoreAwayTeam.HorizontalBars.Scores.Score1 = score[1][0];
        competition.scoreAwayTeam.HorizontalBars.Scores.Score2 = score[1][1];
        competition.scoreAwayTeam.HorizontalBars.Scores.Score3 = score[1][2];
        competition.scoreAwayTeam.HorizontalBars.Scores.Score4 = score[1][3];
    ...
    async load(id, templateElement) {
        ...
        let scoreDisciplineAway = competition.scoreAwayTeam.HorizontalBars.Scores;
